...
public class DomainGuiceProviderModule extends AbstractModule {
    ...
    private static final Integer COURSE_TYPE_ID = 3;
    ...
    private Course getCourse() {
        return GameCourse.Builder.builder()
                .withId(COURSE_ID)
                .withName("Test Course")
                .withDescription("In memory Test Course generated by Provider")
                .withCourseTypeId(COURSE_TYPE_ID)
                .withPathIds(Arrays.asList(
                       7, 8, 9, 10, 11, 12, 13
                        )
                )
                .build();
    ...
    private GameState getGameState() {
        return GameState.Builder.builder()
                .withRolling(false)
                .withPathIndex(0)
                .build();
    }
