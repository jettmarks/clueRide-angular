...
import com.clueride.domain.account.principal.BadgeOsPrincipalServiceImpl;
import com.clueride.domain.account.principal.BadgeOsPrincipalStore;
import com.clueride.domain.account.principal.BadgeOsPrincipalStoreJpa;
...
import com.clueride.domain.invite.InvitationStoreJpa;
...
public class DomainGuiceModule extends AbstractModule {
    ...
    protected void configure() {
        ...
        bind(InvitationStore.class).to(InvitationStoreJpa.class);
        ...
        bind(TeamStore.class).to(TeamStoreJpa.class);
